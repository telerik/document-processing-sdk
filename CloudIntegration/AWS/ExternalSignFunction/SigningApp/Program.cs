...
// Add Signature flags to prevent modifications after signing
document.AcroForm.SignatureFlags = SignatureFlags.AppendOnly;

ExportDocument(provider, document);

/// <summary>
/// Imports a PDF document from the Resources folder.
/// </summary>
/// <param name="provider">The PDF format provider used to import the document.</param>
/// <returns>The imported RadFixedDocument.</returns>
...
/// <summary>
/// Exports the signed PDF document to a file and opens it.
/// </summary>
/// <param name="provider">The PDF format provider used to export the document.</param>
/// <param name="document">The RadFixedDocument to export.</param>
